...
public class CancelTopicFine extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String result = itopic.updateTopic(user, new TopicImpl().selectTopicByTopicId(Integer.parseInt(topicid)), -1, 0);
		...
		if(result == null){
			...
			out.print("<center><h2>取消加精成功</h2></center>"
                +"<center><a href="+basePath+"page/index.jsp>3秒之后返回主页，没有跳转点击此处</a></center>");
			response.setHeader("refresh","3;url=../page/index.jsp");
		}
		else{
